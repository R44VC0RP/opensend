...
export function createSeed(now = Date.now()): DemoState {
  ...
  const keys: ApiKey[] = [
    { id: 'key_production', name: 'Production application', prefix: 'demo_prod_', permission: 'send', domainId: 'dom_acme', createdAt: ago(30 * 24), lastUsedAt: ago(1) },
    { id: 'key_analytics', name: 'Analytics dashboard', prefix: 'demo_read_', permission: 'read', domainId: null, createdAt: ago(14 * 24), lastUsedAt: ago(3) },
  ]
