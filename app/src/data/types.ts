...
export interface CampaignTemplateDraft { name: string; description: string; subject: string; previewText?: string; fromName?: string; replyTo: string[]; tracking: boolean; defaults: Record<string, string | number | boolean | null>; html?: string; attachments: string[] }
