...
const navigation = [['/', 'Overview'], ['/logs', 'Logs'], ['/campaigns', 'Campaigns'], ['/templates', 'Templates'], ['/contacts', 'Contacts'], ['/audience-sync', 'Audience sync'], ['/lists', 'Lists'], ['/segments', 'Segments'], ['/api-keys', 'API keys'], ['/domains', 'Domains'], ['/developer', 'Developer'], ['/settings', 'Settings']] as const
