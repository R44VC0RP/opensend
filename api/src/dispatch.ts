...
export async function drain(runtime: Runtime, limit = 1) { return processJobs(await resolveRegionRuntime(runtime), { ...jobHandlers, ...operationJobs, ...sesRegionJobs, ...templateJobs, ...authoringJobs, 'maintenance.deleteAttachment': deleteAttachment }, limit); }
