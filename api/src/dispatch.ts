...
export async function drain(runtime: Runtime, limit = 1) { return processJobs(await resolveRegionRuntime(runtime), { ...jobHandlers, ...operationJobs, ...sesRegionJobs, 'maintenance.deleteAttachment': deleteAttachment }, limit); }
