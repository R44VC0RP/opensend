...
export function renderBlockHtml(html: string, options: { fontBase?: string; title?: string } = {}): string {
  ...
  const fonts = options.fontBase ? `<style data-opensend-fonts>@font-face{font-family:Inter;src:url('${escape(options.fontBase)}inter-variable.woff2') format('woff2');font-style:normal;font-weight:100 900}@font-face{font-family:Inter;src:url('${escape(options.fontBase)}inter-variable-italic.woff2') format('woff2');font-style:italic;font-weight:100 900}</style>` : '';
